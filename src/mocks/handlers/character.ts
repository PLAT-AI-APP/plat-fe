...
const mockCharacterDetail: CharacterDetail = {
  ...
  isOfficial: true,
  images: [
    { id: "preview-1", url: CHARACTER_PREVIEW_IMAGES.first, visibility: "PUBLIC" },
    { id: "preview-2", url: CHARACTER_PREVIEW_IMAGES.second, visibility: "PRIVATE" },
    { id: "preview-3", url: CHARACTER_PREVIEW_IMAGES.third, visibility: "PUBLIC" },
    { id: "preview-4", url: CHARACTER_PREVIEW_IMAGES.fourth, visibility: "PRIVATE" },
    { id: "preview-5", url: CHARACTER_PREVIEW_IMAGES.fifth, visibility: "PUBLIC" },
  ],
