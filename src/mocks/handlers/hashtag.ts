...
const TAG_SEEDS: { label: string; category: HashtagCategory }[] = [
  ...
  { label: "학교생활", category: "BACKGROUND" },
  { label: "카페", category: "BACKGROUND" },
  { label: "여행", category: "BACKGROUND" },
  { label: "공부", category: "BACKGROUND" },
  { label: "취미", category: "GENRE" },
  { label: "운동", category: "GENRE" },
  { label: "영화", category: "MOOD" },
  { label: "음악", category: "MOOD" },
