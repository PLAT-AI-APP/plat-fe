...
const CharacterPreview = ({ activeScenarioIndex }: CharacterPreviewProps) => {
  ...
  return (
    <section className="flex h-full max-h-[calc(100dvh-var(--header-height)-5.5rem)] w-full max-w-[693px] shrink-0 flex-col gap-12 rounded-3xl bg-darker p-4 lg:h-[919px]">
