...
const CharacterCardPreviewPanel = () => {
  ...
  return (
    <section className="flex h-full max-h-[calc(100dvh-var(--header-height)-5.5rem)] w-full max-w-[693px] flex-col overflow-y-auto rounded-3xl bg-darker p-4 lg:h-[919px]">
