const en = {
  ...
  tokenCharge: {
    ...
    payment: {
      ...
      failedDescription: "Your payment wasn't approved, so you haven't been charged. Please try again in a moment.",
      cancelledTitle: "Payment cancelled",
      cancelledDescription: "No charge was made. You can top up again anytime.",
      retry: "Try again",
      goHome: "Go home",
      confirmingTitle: "Confirming your payment",
      confirmingHint: "Please keep this page open for a moment.",
      checkingHint: "This is taking a little longer than usual. We'll add your notes as soon as it's confirmed.",
      delayedTitle: "Confirmation is taking a while",
      delayedHint: "If the payment went through, your notes will be added automatically.",
      grantingTitle: "Payment complete",
      grantingHint: "Your notes will arrive shortly.",
    },
    myNote: "My notes",
