...
const vi: typeof en = {
  ...
  tokenCharge: {
    ...
    payment: {
      ...
      granting: "Thanh toán hoàn tất. Ghi chú sẽ sớm được cộng.",
      cancelled: "Đã hủy thanh toán.",
      failed: "Thanh toán thất bại. Vui lòng thử lại.",
      backToCharge: "Quay lại trang nạp",
      delayed: "Việc xác nhận thanh toán đang mất nhiều thời gian. Nếu thanh toán thành công, ghi chú sẽ được cộng tự động.",
