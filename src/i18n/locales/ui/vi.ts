...
const vi = {
  ...
  earnings: {
    ...
    points: "{value}P",
    available: "Có thể đổi",
    convert: "Chuyển đổi",
    history: "Lịch sử",
    cancel: "Hủy",
    close: "Đóng",
    giftCards: "Đổi thẻ quà tặng",
    noteConverted: "Đã chuyển {count} note",
    giftRefunded: "Hoàn điểm {name}",
    ledgerType: {
      ACCRUE: "Thu nhập trò chuyện",
      REDEEM: "Đã đổi",
      REDEEM_CANCEL: "Hoàn điểm",
      EXPIRE: "Hết hạn",
      WITHDRAW_FORFEIT: "Bị hủy",
    ...
    monthFormat: "[Tháng] M/YYYY",
    dayFormat: "D/M",
    prevMonth: "Tháng trước",
    nextMonth: "Tháng sau",
    empty: {
      ledger: "Tháng này chưa có lịch sử",
      products: "Chưa có thẻ quà tặng để đổi",
    },
    exchange: {
    ...
    conversion: {
      ...
      usePoints: "Điểm sử dụng",
      remainPoints: "Điểm còn lại",
      done: "Đã chuyển thành {count} note",
      granting: "Đang cộng note, vui lòng chờ giây lát",
    },
    bannerTitle: "Thu nhập của tôi",
  },
  usageHistory: {
