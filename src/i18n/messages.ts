...
const ko = {
  ...
  field: {
    ...
    error: {
      ...
      reportDetailRequired: "기타를 선택했다면 신고 내용을 입력해 주세요",
      reportDetailMaxLength: "상세 내용은 최대 1000자까지 입력할 수 있어요",
...
const en: Messages = {
  ...
  field: {
    ...
    error: {
      ...
      reportDetailMaxLength: "Details can be up to 1000 characters long",
...
const ja: Messages = {
  ...
  field: {
    ...
    error: {
      ...
      reportDetailRequired: "「その他」を選んだ場合は内容を入力してください",
      reportDetailMaxLength: "詳細は最大1000文字まで入力できます",
...
const zh: Messages = {
  ...
  field: {
    ...
    error: {
      ...
      reportDetailMaxLength: "详细内容最多可输入 1000 个字符",
...
const th: Messages = {
  ...
  field: {
    ...
    error: {
      ...
      reportReasonRequired: "กรุณาเลือกเหตุผลการรายงาน",
      reportDetailRequired: "หากเลือก \"อื่นๆ\" กรุณากรอกรายละเอียด",
      reportDetailMaxLength: "รายละเอียดสามารถกรอกได้สูงสุด 1000 ตัวอักษร",
...
const vi: Messages = {
  ...
  field: {
    ...
    error: {
      ...
      reportDetailMaxLength: "Chi tiết tối đa 1000 ký tự",
