...
const ko = {
  characterCreate: {
    ...
    details: {
      label: "캐릭터 상세 설정",
      description:
        "세계관과 캐릭터의 성격, 말투, 외모 등 캐릭터 정보를 적어주세요.",
    },
    settings: {
      publicLabel: "공개 여부",
      ...
      tendencyLabel: "성향",
      tendencyHelp: "선택된 성향에 따라 사용자에게 추천돼요.",
      categoryLabel: "카테고리",
      noCategory: "[선택 없음]",
      categoryHelp: "캐릭터와 잘 어울리는 카테고리를 골라주세요.",
      tagPlaceholder: "태그를 등록해주세요.",
      tagLabel: "태그 등록({count}/5)",
    ...
    tagSuggestion: {
      ...
      close: "모달 닫기",
      nameLabel: "해시태그",
      namePlaceholder: "제안할 해시태그를 입력해주세요.",
      opinionLabel: "의견",
      opinionPlaceholder:
...
const en: typeof ko = {
  characterCreate: {
    ...
    details: {
      ...
      description:
        "Describe the world, personality, speech style, appearance, and other character details.",
    },
    settings: {
      publicLabel: "Visibility",
      ...
      tendencyHelp: "The selected audience affects recommendations for users.",
      categoryLabel: "Category",
      noCategory: "[No selection]",
      categoryHelp: "Choose the category that best fits the character.",
    ...
    tagSuggestion: {
      ...
      close: "Close modal",
      nameLabel: "Hashtag",
      namePlaceholder: "Enter the hashtag you want to suggest.",
...
const ja: typeof ko = {
  characterCreate: {
    ...
    details: {
      label: "キャラクター詳細設定",
      description:
        "世界観や性格、話し方、外見などキャラクター情報を入力してください。",
    },
    settings: {
      publicLabel: "公開設定",
      ...
      tendencyLabel: "傾向",
      tendencyHelp: "選択した傾向に応じてユーザーにおすすめされます。",
      categoryLabel: "カテゴリー",
      noCategory: "[未選択]",
      categoryHelp: "キャラクターに合うカテゴリーを選んでください。",
      tagPlaceholder: "タグを登録してください。",
      tagLabel: "タグ登録 ({count}/5)",
...
const zh: typeof ko = {
  characterCreate: {
    ...
    settings: {
      ...
      tendencyLabel: "倾向",
      tendencyHelp: "所选倾向会影响向用户的推荐。",
      categoryLabel: "分类",
      noCategory: "[未选择]",
      categoryHelp: "请选择最适合角色的分类。",
      tagPlaceholder: "请添加标签。",
      tagLabel: "标签 ({count}/5)",
...
const th: typeof ko = {
  characterCreate: {
    ...
    details: {
      label: "ตั้งค่ารายละเอียดตัวละคร",
      description:
        "กรุณากรอกข้อมูลตัวละคร เช่น โลกทัศน์ บุคลิก วิธีพูด และรูปลักษณ์",
    },
    settings: {
      publicLabel: "การเผยแพร่",
      descriptionLabel: "คำอธิบายตัวละคร",
      descriptionHelp:
        "กรุณาเขียนรายละเอียด เช่น บุคลิก เรื่องราว หรือเหตุการณ์ของตัวละคร",
      tendencyLabel: "แนวโน้ม",
      tendencyHelp: "แนวโน้มที่เลือกจะมีผลต่อการแนะนำให้ผู้ใช้",
      categoryLabel: "หมวดหมู่",
      noCategory: "[ยังไม่ได้เลือก]",
      categoryHelp: "เลือกหมวดหมู่ที่เหมาะกับตัวละครมากที่สุด",
      tagPlaceholder: "กรุณาเพิ่มแท็ก",
    ...
    tagSuggestion: {
      ...
      close: "ปิดโมดัล",
      nameLabel: "แฮชแท็ก",
      namePlaceholder: "กรอกแฮชแท็กที่คุณต้องการแนะนำ",
...
const vi: typeof ko = {
  characterCreate: {
    ...
    details: {
      label: "Thiết lập chi tiết nhân vật",
      description:
        "Hãy viết thông tin nhân vật như bối cảnh thế giới, tính cách, cách nói chuyện và ngoại hình.",
    },
    settings: {
      publicLabel: "Hiển thị",
      ...
      tendencyHelp: "Khuynh hướng đã chọn sẽ ảnh hưởng đến đề xuất cho người dùng.",
      categoryLabel: "Danh mục",
      noCategory: "[Chưa chọn]",
      categoryHelp: "Hãy chọn danh mục phù hợp nhất với nhân vật.",
      tagPlaceholder: "Vui lòng thêm thẻ.",
    ...
    tagSuggestion: {
      ...
      close: "Đóng modal",
      nameLabel: "Hashtag",
      namePlaceholder: "Hãy nhập hashtag bạn muốn đề xuất.",
      opinionLabel: "Ý kiến",
      opinionPlaceholder:
