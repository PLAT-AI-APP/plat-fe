...
const ko = {
  modalUi: {
    ...
    report: {
      titleComment: "댓글 신고",
      titleUniverse: "캐릭터 신고",
      description: "신고 내용은 운영팀만 확인해요",
      reasonLabel: "신고 사유",
      detailLabel: "상세 내용",
      detailPlaceholder: "문제가 되는 부분을 알려주시면 검토에 도움이 돼요",
...
const en: typeof ko = {
  modalUi: {
    ...
    report: {
      ...
      titleUniverse: "Report character",
      description: "Only our moderation team can see your report.",
      reasonLabel: "Reason",
      detailLabel: "Details",
      detailPlaceholder: "Telling us what's wrong helps us review it.",
...
const ja: typeof ko = {
  modalUi: {
    ...
    report: {
      titleComment: "コメントを通報",
      titleUniverse: "キャラクターを通報",
      description: "通報内容は運営チームのみが確認します",
      reasonLabel: "通報理由",
      detailLabel: "詳細",
      detailPlaceholder: "問題のある箇所を教えていただけると確認に役立ちます",
...
const zh: typeof ko = {
  modalUi: {
    ...
    report: {
      titleComment: "举报评论",
      titleUniverse: "举报角色",
      description: "举报内容仅运营团队可见",
      reasonLabel: "举报原因",
      detailLabel: "详细内容",
      detailPlaceholder: "告诉我们具体问题，有助于我们审核",
...
const th: typeof ko = {
  modalUi: {
    ...
    report: {
      titleComment: "รายงานความคิดเห็น",
      titleUniverse: "รายงานตัวละคร",
      description: "เฉพาะทีมผู้ดูแลเท่านั้นที่เห็นรายงานของคุณ",
      reasonLabel: "เหตุผลการรายงาน",
      detailLabel: "รายละเอียด",
      detailPlaceholder: "บอกเราว่ามีปัญหาตรงไหน จะช่วยในการตรวจสอบ",
...
const vi: typeof ko = {
  modalUi: {
    ...
    report: {
      titleComment: "Báo cáo bình luận",
      titleUniverse: "Báo cáo nhân vật",
      description: "Chỉ đội ngũ quản trị mới xem được báo cáo của bạn",
      reasonLabel: "Lý do báo cáo",
      detailLabel: "Chi tiết",
      detailPlaceholder: "Cho chúng tôi biết vấn đề cụ thể sẽ giúp việc xem xét",
