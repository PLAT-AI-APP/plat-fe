...
const ko = {
  ...
  characterDetail: {
    ...
    privateImagePrompt: "캐릭터의 다른 모습을 보고 싶다면?",
...
const en = {
  ...
  characterDetail: {
    ...
    privateImagePrompt: "Want to see another side of this character?",
...
const ja = {
  ...
  characterDetail: {
    ...
    privateImagePrompt: "キャラクターの別の姿を見たいですか？",
    previousImage: "前の画像",
    nextImage: "次の画像",
    prologue: "プロローグ",
...
const zh = {
  ...
  characterDetail: {
    ...
    privateImagePrompt: "想看看这个角色的另一面吗？",
    previousImage: "上一张图片",
    nextImage: "下一张图片",
    prologue: "序章",
...
const th = {
  ...
  characterDetail: {
    ...
    privateImagePrompt: "อยากดูอีกมุมของตัวละครนี้ไหม?",
...
const vi = {
  ...
  characterDetail: {
    ...
    privateImagePrompt: "Muốn xem một khía cạnh khác của nhân vật này không?",
