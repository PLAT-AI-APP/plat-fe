...
const ko: RuntimeMessages = {
  ...
  tokenCharge: {
    ...
    payment: {
      ...
      granting: "결제가 완료되었어요. 노트는 곧 지급돼요.",
      cancelled: "결제를 취소했어요.",
      failed: "결제에 실패했어요. 다시 시도해 주세요.",
      backToCharge: "충전 페이지로",
      delayed: "결제 확인이 늦어지고 있어요. 결제가 완료됐다면 노트는 자동으로 들어와요.",
      successTitle: "충전 완료!",
      balanceLabel: "현재 보유",
...
const ja: RuntimeMessages = {
  ...
  tokenCharge: {
    ...
    payment: {
      ...
      granting: "決済が完了しました。ノートはまもなく付与されます。",
      cancelled: "決済をキャンセルしました。",
      failed: "決済に失敗しました。もう一度お試しください。",
      backToCharge: "チャージページへ",
      delayed: "決済の確認に時間がかかっています。決済が完了していればノートは自動で付与されます。",
      successTitle: "チャージ完了！",
      balanceLabel: "現在の保有",
...
const zh: RuntimeMessages = {
  ...
  tokenCharge: {
    ...
    payment: {
      ...
      granting: "支付已完成，笔记将很快到账。",
      cancelled: "已取消支付。",
      failed: "支付失败，请重试。",
      backToCharge: "返回充值页面",
      delayed: "支付确认时间较长。如果支付已完成，笔记将自动到账。",
      successTitle: "充值成功！",
      balanceLabel: "当前余额",
      goExplore: "去认识角色",
      failedTitle: "支付失败",
...
const th: RuntimeMessages = {
  ...
  tokenCharge: {
    ...
    payment: {
      ...
      confirming: "กำลังยืนยันการชำระเงิน…",
      success: "เติม {credits} โน้ตเรียบร้อยแล้ว",
      granting: "ชำระเงินเรียบร้อยแล้ว โน้ตจะเข้าบัญชีในไม่ช้า",
      cancelled: "ยกเลิกการชำระเงินแล้ว",
      failed: "การชำระเงินล้มเหลว โปรดลองอีกครั้ง",
      backToCharge: "กลับไปหน้าเติมโทเค็น",
      delayed: "การยืนยันการชำระเงินใช้เวลานานกว่าปกติ หากชำระเงินสำเร็จ โน้ตจะเข้าบัญชีโดยอัตโนมัติ",
