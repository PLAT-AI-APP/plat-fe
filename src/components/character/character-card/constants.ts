...
export const SIZE_CONFIG: Record<CardSize, SizeConfig> = {
  S: {
    ...
    desc: "body-7 text-font-2",
    isIntegrated: false,
    creatorName: "body-7 text-font-disabled",
    chatCount: "body-7 text-font-disabled",
  ...
  L: {
    ...
    desc: "body-6 text-overlay-font/70",
    creatorName: "body-7 text-overlay-font/60",
    isIntegrated: true,
    chatCount: "body-7 text-overlay-font/60",
